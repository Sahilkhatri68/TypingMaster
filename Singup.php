 <!-- <?php
    ...
    if (isset($_POST['signup'])) {
        ...
        if ($password == $cpsw) {
            $insert = "INSERT INTO testing(name,email,password) VALUES('$name','$email','$password')";

            $check = mysqli_query($conn, $insert);
            header("location:http://projects.test/logincaptcha/Login.php");
        } else {
 ...
 <body>
     <form class="maindiv" method="POST">
         <div class="insidediv">
             <button class="btnone" type="submit" name="signup">
                 reC<span class="sp">r</span>ash
             </button>
             <div class="empty">
             </div>
             <div class="bottomcont">
                 <div class="contone">Signup Here!</div>
                 <div class="bottomdiv">
                     <div class="conttwo">
                         <input type="text" name="name" id="" placeholder="name" class="inputt" required>
                     </div>
                     <div class="conttwo">
                     ...
                     <div class="conttwo">
                         <input type="password" name="cpsw" id="" placeholder="password" class="inputt" required>
             ...
             <div class="itemsdiv">
                 <!-- <div class="item"> <input type="checkbox" name="" id="">Remember </div> -->
             </div>
         </div>
     </form>
 </body>
